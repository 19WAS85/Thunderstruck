...
<pre>
var select = new DataObjectQuery<Car>(table: "TB_CARS");

var select = new DataObjectQuery<Car>(primaryKey: "IdCar");

var select = new DataObjectQuery<Car>(table: "TB_CARS", primaryKey: "IdCar");
</pre>
